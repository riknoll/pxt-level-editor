const gallery = [{ name: 'big', image: './gallery-icons/bigFood/big.png', height: 16, width: 16, frames: ['Burger', 'Drumstick', 'Ham', 'Pizza', 'Taco', 'Cake', 'Donut', 'IceCream'] },
{ name: 'plate', image: './gallery-icons/bigFood/plate.png', frames: [] },
{ name: 'heroFrontAttack', image: './gallery-icons/castle/heroFrontAttack.png', height: 24, width: 24, frames: ['1', '2', '3', '4'] },
...
{ name: 'duck', image: './gallery-icons/duck/duck.png', height: 16, width: 16, frames: ['1', '2', '3', '4', '5', '6'] },
